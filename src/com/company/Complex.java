...
public class Complex  {
        ...
        private static final double EPS = 0.0000000000001; // Точность вычислений
...
public String toString(){
        ...
        public static Complex sin(Complex z){
                ...
                return new Complex(Math.sin(z.getRe()),0.0);
        ...
        public static Complex cos(Complex z){
                ...
                return new Complex(Math.cos(z.getRe()),0.0);
        ...
        public static Complex atan(Complex z){
                ...
                return new Complex(Math.atan(z.getRe()),0.0);
        ...
        public static Complex pow(Complex z,int n){
                ...
                return new Complex(Math.pow((z.getRe()),n),0.0);
